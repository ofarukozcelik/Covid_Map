const Loader = ({ type }) => {
  ...
  // Map ile dönmek için 16 elemanlı bir dizi oluşturduk.
  const arr = new Array(16).fill();


  return arr.map((i, key) => (

    <div data-testid="card-loader" key={key} className="text-gray-200 p-4 rounded-lg shadow-md text-transparent min-w-[206px] animate-pulse select-none">
